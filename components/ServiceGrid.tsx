...
export function ServiceGrid() {
  return (
    <AnimatedSection id="services" className="relative z-10 mx-auto max-w-7xl px-6 pb-12 pt-24 lg:px-10 lg:pb-14 lg:pt-28">
      <div className="absolute left-0 top-32 -z-10 h-72 w-72 rounded-full bg-cyan-300/10 blur-3xl" />
      <div className="absolute bottom-6 right-0 -z-10 h-72 w-72 rounded-full bg-emerald-300/10 blur-3xl" />
          ...
          return (
            <article
              ...
              className={`group relative overflow-hidden rounded-[2.2rem] border border-white/10 bg-white/[0.045] p-6 shadow-2xl shadow-black/20 transition duration-500 hover:-translate-y-2 hover:border-cyan-300/35 hover:bg-white/[0.075] ${
                isFeature ? "lg:col-span-3 lg:min-h-[340px] lg:p-8" : "lg:col-span-2 lg:min-h-[290px]"
              }`}
            >
              ...
              <div className={isFeature ? "mt-12" : "mt-10"}>
              ...
              <div className="mt-8 flex items-center gap-2 text-sm font-black text-cyan-200 opacity-0 transition duration-500 group-hover:opacity-100">
                Lihat arah solusi
